...
// Note: Do NOT override getTransformOptions here — Expo's defaults enable
// inlineRequires which is critical for fast cold starts. Overriding it
// with inlineRequires: false caused the app to evaluate all modules
// (20 locales, lucide icons, reanimated, heroui) at entry require time.
