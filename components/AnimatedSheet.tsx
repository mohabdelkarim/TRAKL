 ...
 * the embedded preview runs — inside the quick-add `transparentModal` route it
...
export function AnimatedSheet({
  ...
  // Start from the closed state even when a sheet is conditionally mounted
  // with visible=true, so the normal opening animation still runs.
